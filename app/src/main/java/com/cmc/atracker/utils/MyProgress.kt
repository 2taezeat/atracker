    ...
    fun init(context: Context, attrs: AttributeSet?) {
        ...
        a = if (attrs != null) {
            context.getTheme().obtainStyledAttributes(
                attrs,
                com.cmc.atracker.R.styleable.MyProgress,
                0, 0)
        } else {
            throw IllegalArgumentException("Must have to pass the attributes")
        }
        try {
            mDrawText = a.getBoolean(com.cmc.atracker.R.styleable.MyProgress_showProgressText, false)
            mBackgroundColor =
                a.getColor(com.cmc.atracker.R.styleable.MyProgress_backgroundColor,             resources.getColor(
                    com.cmc.atracker.R.color.background_gray))
            mPrimaryProgressColor =
                a.getColor(com.cmc.atracker.R.styleable.MyProgress_progressColor,            resources.getColor(com.cmc.atracker.R.color.progress_color_2))
            mSecondaryProgressColor =
                a.getColor(com.cmc.atracker.R.styleable.MyProgress_secondaryProgressColor, resources.getColor(com.cmc.atracker.R.color.progress_color_4))
            mProgress = a.getInt(com.cmc.atracker.R.styleable.MyProgress_progress, 0)
            mSecondaryProgress = a.getInt(com.cmc.atracker.R.styleable.MyProgress_secondaryProgress, 0)
            mStrokeWidth = a.getDimensionPixelSize(com.cmc.atracker.R.styleable.MyProgress_strokeWidth, 10)
            mTextColor = a.getColor(com.cmc.atracker.R.styleable.MyProgress_textColor, resources.getColor(R.color.black))
            mPrimaryCapSize = a.getInt(com.cmc.atracker.R.styleable.MyProgress_primaryCapSize, 10)
            mSecondaryCapSize = a.getInt(com.cmc.atracker.R.styleable.MyProgress_secondaryCapSize, 10)
            isPrimaryCapVisible = a.getBoolean(com.cmc.atracker.R.styleable.MyProgress_primaryCapVisibility, true)
            isSecondaryCapVisible = a.getBoolean(com.cmc.atracker.R.styleable.MyProgress_secondaryCapVisibility, true)


            mThirdProgressColor = a.getColor(com.cmc.atracker.R.styleable.MyProgress_thirdProgressColor, resources.getColor(com.cmc.atracker.R.color.progress_color_7))
            mThirdProgress = a.getInt(com.cmc.atracker.R.styleable.MyProgress_thirdProgress, 0)
            mThirdCapSize = a.getInt(com.cmc.atracker.R.styleable.MyProgress_thirdCapSize, 10)
            isThirdCapVisible = a.getBoolean(com.cmc.atracker.R.styleable.MyProgress_thirdCapVisibility, true)
